...
require_once $rootDir . '/Business/Progress/DBScanProgressToFile.php';
...
require_once $rootDir . '/Business/Progress/DBScanClusteringProgress.php';
require_once $rootDir . '/Business/Algorithms/DBScanAlgorithm.php';
